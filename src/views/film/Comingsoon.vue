  ...
  >
    ...
    >
      ...
      >
        ...
        <button @click.stop="handleClickBuy()">预购</button>
      </li>
    </van-cell>
  </van-list>
</template>
...
export default {
  ...
  methods: {
    onLoad () {
      // 异步更新数据
      comingsoonAPI(this.pageNum).then(res => {
        ...
        console.log('comingsoon-数据请求成功')
      })
      this.pageNum++
    },
    handleClickDetail (id) {
      this.$router.push(`/detail/${id}`)
      this.$store.commit('SET_DETAIL_FROM', 'comingsoon')
    },
    handleClickBuy () {
